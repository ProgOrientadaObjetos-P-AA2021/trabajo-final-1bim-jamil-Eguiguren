 ...
 */
package escrivirarchivodepartamentos;
...
public class EscribirArchivoDepartamento {
    ...
    public EscribirArchivoDepartamento(String nombreArc) {
    ...
    public void establecerLista() {
        LeerArchivoDepartamento l = new LeerArchivoDepartamento(obtenerNombreArchivo());
        l.establecerDepartamento();
        lista = l.obtenerdepartamento();
    }
